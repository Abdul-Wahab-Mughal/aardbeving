    ...
    <main className="bg-white">
      ...
      <section className="bg-gray-200">
        ...
        <div className=" container m-auto py-10 px-5 lg:px-20 text-black flex flex-col">
          <div className=" grid md:grid-cols-2 gap-5 m-auto bg-white p-5 text-black rounded-xl">
            <div className=" flex flex-row gap-2.5">
              <Check
                className="min-w-7 min-h-7 p-1 bg-[--background_box] rounded-full"
                color="white"
              />
              <p className="text-sm">
          ...
          <div className=" grid md:grid-cols-2 gap-5 m-auto bg-white p-5 text-black rounded-xl">
            ...
            <div className=" flex flex-row gap-2.5">
              ...
              <p className="text-sm">
                ...
                analyse. Deze kan u helpen om beter te begrijpen wat er
                technisch speelt en vormt een inhoudelijke basis voor gesprekken
